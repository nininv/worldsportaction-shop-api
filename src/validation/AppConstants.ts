const AppConstants = {
  ...
  productTemplate:
    '$(name) as a $(player, coach, umpire) for $(Competition_Name) with $(Affiliate_Name). Your Competition starts on $(start_date).<br><br>',
  singleUserMultipleComp: '$(player, coach, umpire) with $(Affiliate_Name) in $(Competition_Name).',

  productTemplateStartDate:
    '$(name) as a $(player, coach, umpire) with $(Affiliate_Name) in $(Competition_Name) starts on $(start_date).',
  coach: 'Coach',
  umpire: 'Umpire',
  coachRoleId: 17,
  umpireRoleId: 15,
  ...
  singleCompValidationMsg:
    '{COMP_NAME}  allows for a player to register to one time only. {PLAYER_NAME} has already been registered to this competition.',
  singleCompDivValidationMsg:
    '{COMP_NAME} does not only allow a player to register to the same Division more than once. {PLAYER_NAME} has already registered to this division.',
  ...
  PIN: '0101',
  VOUCHER_TYPE: 'AK',
  singleCompTemplateWithoutUserName:
    'You have successfully registered as $(player, coach, umpire) with $(Affiliate_Name) in $(Competition_Name).',
  singeCompTemplateWithUserName:
    'You have successfully registered $(name) as $(player, coach, umpire) with $(Affiliate_Name) in $(Competition_Name).',
  DE_REGISTER: 1,
  TRANSFER: 2,
  APPROVED: 1,
  PARTIAL_APPROVED: 2,
  ...
  youCanLoginToProfile:
    'You can login and see your profile and activity at anytime by <a href="$(url)">clicking here</a>.',
  passThisEmailTo:
  ...
  passThisEmailTo1:
    'Please pass this email onto $(names) to access Profile and Activity summary at anytime by <a href="$(url)">clicking here</a>.',
  names: '$(names)',
  PROCESSING: 3,
  member: '$(member)',
  installmentDateAndAmount: '$(installment_date_amount)',
  installmentPaymentDeductedOn:
    '<br> An Instalment payment for the competition Fees will  be deducted on: $(installment_date_amount)',
  ...
  chargedIfNotPaidFees:
    '<br>As mentioned during registration if $(not_paid_members) fails to pay their fees prior to the commencement of the competition you will be charged any outstanding monies.',
  ...
  thankYouForRegDebitCard:
    '<br><br>Thank you for registering the team - $(team_name) with $(Affiliate_Name) in $(Competition_Name).',
  owing: 'OWING',
  paid: 'Paid',
  forTeamTeamName: 'for team - $(team_name)',
  exceedMessage:
    'Registration Cap for the Membership Type is exceeded. Please select another Division / Competition.',
  activeKidServiceUnavailable:
    'The NSW Active Kids Portal is currently unavailable. Please try again later.',
  ...
  your: 'your',
  colonAndDot: ':.',
  voucherPosIdNotConfigured:
    'Your organisation is not configured for Active Kids - please contact your administrator.',
  voucherPostalCodeNotConfigured:
    'Your organisation is not configured for Active Kids - please contact your administrator.',
  voucherStoreChannelCodeNotConfigured:
    'Your organisation is not configured for Active Kids - please contact your administrator.',
  invalidPinVoucher:
    'The date of birth you’ve entered doesn’t match the date of birth for this voucher.',
  parentHasSameEmail:
    'You have used the same email to register yourself as your parent/ guardian. Please note that the child/ parent will not receive a seperate email with their log in details. If you would like them to have their own log-in you will need to login to your profile and click on their name and change their email address. Then get them to  login as that user and click reset password.',
  childHasDiffEmail:
    '$(names) has been sent their username and password on $(email) and can log in at anytime to access their profile.',
  withParentEmailNote:
    '<tr><td colspan="2" class="ind-subtext">** Will not get their own login as you have provided the same email address as yourself. You can access their profile from your login to update their email address and then ask them to reset their password in order to get their own login.</td></tr>',
  childRegistererWithParentEmailNote:
    '<tr><td colspan="2" class="ind-subtext">** Will not get own login as you have provided the same email address as your parent. Your parent can switch to your profile and update your email address, then you can reset your password in order to get your own login.</td></tr>',
  otherMemberPrefix: '$(otherMembers)',
  otherMemberNoteSingle:
    '$(otherMembers) has been sent their username and password via email and can log in at anytime to access their profile.',
  otherMemberNote:
    '$(otherMembers) have been sent their username and password via email and can log in at anytime to access their profile.',
  umpireNote:
    'Please update Umpire availability on profile, also (if applicable) add bank account details to receive payments for Umpiring duties.',
  parentsLogin: '(Parent`s login)',
  emailYou: 'email you',
  youSentence: 'you',
  email: 'email',
  instalmentVoucherMsg:
    'Instalments can’t be used if a voucher has been applied. Please select another payment option.',
  ...
  cardDeclinedInsufficientFunds:
    'This Payment could not be processed due to insufficient funds. Please contact you Bank.',
  ...
  perMatch: 'per_match',
  refundingWarningMsg:
    'A Refund is not permitted as a user can only be refunded the amount they paid. A government Voucher may have been applied for this user.',
};
